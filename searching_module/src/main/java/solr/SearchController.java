...
public class SearchController {
    ...
    private List<Book> getIdMatchedBooks(SolrClient solr, String query) {
        ...
        List<Book> partiallyMatchedBooks = getPartiallyMatchedBooks(solr, "id", query, "%s", 4, 3);
    ...
    private List<Book> getGenreMatchedBooks(SolrClient solr, String query) {
        ...
        List<Book> partiallyMatchedBooks = getPartiallyMatchedBooks(solr, "genre", query, "%s", 3, 3);
    ...
    private List<Book> getAuthorNameMatchedBooks(SolrClient solr, String query) {
        ...
        List<Book> partiallyMatchedBooks = getPartiallyMatchedBooks(solr, "authorName", query, "%s", 3, 5);

        List<Book> partiallyMatchedBooks1 = getPartiallyMatchedBooks(solr, "authorName", query, "%s*", 3, 3);
    ...
    private List<Book> getAuthorSurnameMatchedBooks(SolrClient solr, String query) {
        ...
        List<Book> partiallyMatchedBooks = getPartiallyMatchedBooks(solr, "authorSurname", query, "%s", 3, 5);
        List<Book> partiallyMatchedBooks1 = getPartiallyMatchedBooks(solr, "authorSurname", query, "%s*", 3, 3);
    ...
    private List<Book> getBookNameMatchedBooks(SolrClient solr, String query) {
        ...
        List<Book> partiallyMatchedBooks = getPartiallyMatchedBooks(solr, "bookName", query, "*%s*", 3, 3);
    ...
    private List<Book> getAnnotationNameMatchedBooks(SolrClient solr, String query) {
        ...
        return getPartiallyMatchedBooks(solr, "annotation", query, "*%s*", 3, 1);
    }
    ...
    private List<Book> getDateMatchedBooks(SolrClient solr, String query) {
        ...
        List<Book> partiallyMatchedBooks = queries.stream().map(query1 -> {
            try {
    ...
    private List<Book> getLanguageMatchedBooks(SolrClient solr, String query) {
        ...
        List<Book> partiallyMatchedBooks = getPartiallyMatchedBooks(solr, "language", query, "%s", 2, 2);
    ...
    private List<Book> getFullMatchedBooks(SolrClient solr, String field, String query) {
        try {
            ...
            QueryResponse response = solr.query(solrQuery);
            List<Book> bookList = response.getBeans(Book.class);
            bookList.forEach(book -> book.addPriority(10));
            return bookList;
    ...
    private List<Book> getPartiallyMatchedBooks(SolrClient solr, String field, String query, String subQueryPattern, int minSymbolCount, int priority) {
        SolrQuery solrQuery = getSolrQuery();
